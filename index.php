...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary sticky-top">
    <div class="container">
        <a class="navbar-brand" href="#">
            <img src="images/icon.png" alt="Logo" width="30" height="26" class="d-inline-block align-text-top">
            &nbsp;&nbsp;<span class="text-dark myLogo">Sladkoejka</span>
        </a>
...
<div class="container-fluid bg-light">
    <div class="text-end">
        <button type="button" class="btn btn-outline-success m-2">Login</button>
        ...
        if ($files !== false) {
            ...
            foreach ($files as $file) {
                if ($file != "." && $file != "..") {
                    ...
                    $active = false;
                    echo "<a href='$dir$file'><img src='$dir$file' alt='$dir$file' class='img-fluid gallery-img' /></a>";
                    echo "</div>";
                }
            }
        }
...
<div class="container my-4 ">
    ...
    <div class="row row-cols-1 row-cols-md-2 g-4">
        <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3">
            <div class="card">
                <img src="images/carusel/img1.jpg" class="card-img-top" alt="Img1">
                <div class="card-body">
        ...
        <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3">
            <div class="card">
                <img src="images/carusel/img2.jpg" class="card-img-top" alt="Img2">
                <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <p class="card-text">This is a longer card with supporting text below as a natural lead-in to
                        additional content.</p>
        ...
        <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3">
            <div class="card">
                <img src="images/carusel/img3.jpg" class="card-img-top" alt="Img3">
                <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <p class="card-text">This is a longer card with supporting text below as a natural lead-in to
                        additional content.</p>
        ...
        <div class="col-sm-12 col-md-6 col-lg-4 col-xl-3">
            <div class="card">
                <img src="images/carusel/img4.jpg" class="card-img-top" alt="Img4">
                <div class="card-body">
                    <h5 class="card-title">Card title</h5>
                    <p class="card-text">This is a longer card with supporting text below as a natural lead-in to
                        additional content.</p>
...
<div class="container p-3">
    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 p-2 imgContact">
            <img src="images/contact.jpg" alt="Contact" class="px-4"/>
        </div>
    </div>
    <hr/>
    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 myMap">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2719.114384639849!2d28.882429414948646!3d47.037986235077646!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x40c97c8a22ff8091%3A0xbf35be0c65d14ccf!2sDulcinella!5e0!3m2!1sen!2s!4v1671476013531!5m2!1sen!2s"
                title="Map"></iframe>
    </div>
</div>
<div class="container-fluid bg-primary">
    <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
        ...
        <ul class="nav col-md-4 justify-content-end list-unstyled d-flex">
            <li class="ms-3"><a class="text-muted" title="icon" href="#">
                    <svg class="bi" width="24" height="24">
                        <use xlink:href="#twitter"/>
                    </svg>
                </a></li>
            <li class="ms-3"><a class="text-muted" title="icon"
                                href="https://www.instagram.com/natalia_plesca_dragancea/">
                    <svg class="bi" width="24" height="24">
                        <use xlink:href="#instagram"/>
                    </svg>
                </a></li>
            <li class="ms-3"><a class="text-muted" title="icon" href="https://www.facebook.com/eUSMinformatica/">
                    <svg class="bi" width="24" height="24">
...
<script>
    ...
    var carousel = new bootstrap.Carousel(myCarousel, {
        interval: 2000, // устанавливает интервал между слайдами в миллисекундах (2000ms = 2 секунды)
